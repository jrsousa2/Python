REM THIS SCRIPT TAKES PARAMETERS AND CREATES A COPY OF THE INPUT VIDEO 
REM STARTING AT TIME INIT AND ENDING AT TIME "END"
REM SAVES THE OUTPUT FILE WITH INIT AND END AS SUFFIX (NOT ANYMORE)

@echo off
REM BELOW IS NEEDED BC VARS ARE BEING SET INSIDE A LOOP
...
REM THE FOLDER THAT HAS THE INPUT FILE
set Diret=%1
echo.
echo THE FOLDER THAT HAS THE INPUT FILE=%Diret%
...
REM SETS THE SEQUENCE OF HE OUTPUT
set Nbr=%5

REM SETS THE CHARACTER
set Persona=%~6
...
REM CREATES FILENAME WITH PATH+NAME
...
REM MOVES THE SUBTITLES A LITTLE UP ABOVE
set Offset=28
echo.
ECHO POSICAO1:
