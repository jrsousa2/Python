...
from artist
inner join (select distinct art from jose) as jose on jose.Art = artist.Name
...
where artist.name = 'Amelinha'
and area2.Name in ('Brazil','United States') and script.Name='Latin';
