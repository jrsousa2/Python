...
# THIS IS NO LONGER NEEDED AND IS NOT AN ISSUE. 
# I FIXED THE WPL AUTOMATIC PLAYLIST FILES AND THIS WENT AWAY.
# THE WMP PLAYLIST CREATION WIZARD DOESN'T SHOW ALL THE OPTIONS, 
# BUT THE CODE/WPL FILE ACCEPTS THEM AND CAN BE EDITED IN PLACE.
