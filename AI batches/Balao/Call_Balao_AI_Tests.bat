...
REM set Input_dir=D:/Videos/Balao2/Input
REM set Output_dir=D:/Videos/Balao2/Output

REM #########################################################################

REM THIS IS FOR TEST PURPOSES ONLY
set Input_dir=D:/Videos/Balao2/5s
set output_dir=D:/Videos/Balao2/Tests/%Sel_model%

REM #########################################################################
REM DEFINE THE 5 MODELS

REM CROP VARIABLE
REM (isso era o original)set crop=increase^,crop=1280:720
set crop=decrease^,pad=1280:720:-1:-1:color=black

set Proteus="tvai_up=model=prob-4:scale=0:w=1280:h=720:preblur=0:noise=0:details=0:halo=0:blur=0:compression=0:estimate=8:blend=0.2:device=0:vram=0.1:instances=1,scale=w=1280:h=720:flags=lanczos:threads=0:force_original_aspect_ratio=%crop%"

set Iris="tvai_up=model=iris-2:scale=0:w=1280:h=720:preblur=0:noise=0:details=0:halo=0:blur=0:compression=0:estimate=8:blend=0.2:device=0:vram=0.1:instances=1,scale=w=1280:h=720:flags=lanczos:threads=0:force_original_aspect_ratio=%crop%"

set Nyx="tvai_up=model=nyx-3:scale=1:w=1280:h=720:preblur=0:noise=0:details=0:halo=0:blur=0:compression=0:estimate=8:device=0:vram=0.1:instances=1,scale=w=1280:h=720:flags=lanczos:threads=0:force_original_aspect_ratio=%crop%"

set Artemis="tvai_up=model=ahq-12:scale=0:w=1280:h=720:blend=0.2:device=0:vram=0.1:instances=1,scale=w=1280:h=720:flags=lanczos:threads=0:force_original_aspect_ratio=%crop%"

set Theia="tvai_up=model=thf-4:scale=0:w=1280:h=720:noise=0:blur=0:compression=0:device=0:vram=0.1:instances=1,scale=w=1280:h=720:flags=lanczos:threads=0:force_original_aspect_ratio=%crop%"
