...
If ExtraFields Then
   objExcel.Cells(1, 12) = "PlayedCount"
   objExcel.Cells(1, 13) = "SkippedCount"
   objExcel.Cells(1, 14) = "Date_added"
   objExcel.Cells(1, 15) = "Grouping"
   objExcel.Cells(1, 16) = "Art_Sort"
   objExcel.Cells(1, 17) = "AA_Sort"
End If
